#include <stdio.h>
#include <mysql/mysql.h>   // livmysql:x64-windows
...
int main(void)
{
	...
	//// INSERT
	//char insert_q[50] = "INSERT INTO korea VALUES('TOKO', 100000)";
	...
	//// DELETE
	//char delete_q[50] = "DELETE FROM korea WHERE city='TOKO'";
	...
	while (TRUE)
	{
		...
		// DB의 int 형 데이터도 문자열로 받는다(sql_row[1])
		printf("%s %s\n", sql_row[0], sql_row[1]);
	}
